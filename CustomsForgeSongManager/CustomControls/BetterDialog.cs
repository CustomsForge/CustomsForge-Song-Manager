...
namespace CustomsForgeSongManager.CustomControls
{
    ...
    public partial class BetterDialog : Form
    {
        ...
        //
        // Sample Usage: 
        // BetterDialog.ShowDialog("Dialog Message", "Dialog Title", "Button1Text", "Button2Text", "Button3Text", Properties.Resources.IconImage, "IconMessage", 150, 150);
        // result = BetterDialog.ShowDialog(null, "Dialog Title", "Button1Text", "Button2Text", "Button3Text", Properties.Resources.IconImage, "IconMessage", 150, 150);
        //
        /// <summary>
        ...
        public static DialogResult ShowDialog(string dialogMessage, string dialogTitle, string textDialogButton1, string textDialogButton2, string textDialogButton3, Image dialogIcon, string iconMessage, int topFromCenter = 0, int leftFromCenter = 0)
        {
            using (BetterDialog dialog = new BetterDialog(dialogMessage, dialogTitle, textDialogButton1, textDialogButton2, textDialogButton3, dialogIcon, iconMessage, topFromCenter, leftFromCenter))
            {
        ...
        /// </summary>
        private BetterDialog(string dialogMessage, string dialogTitle, string textDialogButton1, string textDialogButton2, string textDialogButton3, Image dialogIcon, string iconMessage, int topFromCenter, int leftFromCenter)
        {
            InitializeComponent();
            ...
            {
                SizeF iconMessageSize;
                SizeF dialogMessageSize;
                ...
                this.Height = (int) iconMessageSize.Height + (int) dialogMessageSize.Height + btn3.Height + heightTweak;
