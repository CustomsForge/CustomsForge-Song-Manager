...
namespace CustomsForgeSongManager.SongEditor
{
    partial class frmTuning
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.string5TB = new CueTextBox();
            this.string4TB = new CueTextBox();
            this.string3TB = new CueTextBox();
            this.string2TB = new CueTextBox();
            this.string1TB = new CueTextBox();
            this.string0TB = new CueTextBox();
            this.nameTB = new CueTextBox();
            this.uiNameTB = new CueTextBox();
