...
namespace CFSM.NCalc
{
    public class NCalcLexer : Lexer {
        ...
        public const int DEFAULT_TOKEN_CHANNEL = DefaultTokenChannel;
        ...
        static readonly short[][] DFA7_transition = DFA_X.UnpackEncodedStringArray(DFA7_transitionS);
        ...
        static readonly short[][] DFA14_transition = DFA_X.UnpackEncodedStringArray(DFA14_transitionS);
