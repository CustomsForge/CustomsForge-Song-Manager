...
namespace CFSM.AudioTools.Ogg
{
    ...
    {
        private const String oggs_str = "OggS";
        ...
        public int flush(Page og, bool force = true, int nfill = 4096)
        {
            int i;
            int vals = 0;
            ...
            byte[] oggs_byt = Encoding.UTF8.GetBytes(oggs_str);
        ...
        {
            if ((e_o_s != 0 && lacing_fill != 0) || /* 'were done, now flush' case */ body_fill - body_returned > 4096 || /* 'page nominal size' case */ lacing_fill >= 255 || /* 'segment table full' case */ (lacing_fill != 0 && b_o_s == 0))
            {
                /* 'initial header page' case */
                return flush(og);
            }
