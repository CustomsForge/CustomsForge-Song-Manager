...
namespace CFSM.AudioTools.Vorbis
{
    internal class Drft
    {
        ...
        private static int[] ntryh = {4, 2, 3, 5};
        private static float tpi = 6.28318530717958647692528676655900577f;
        private static float hsqt2 = .70710678118654752440084436210485f;
        private static float taui = .86602540378443864676372317075293618f;
        private static float taur = -.5f;
        private static float sqrt2 = 1.4142135623730950488016887242097f;
        ...
        private static void dradfg(int ido, int ip, int l1, int idl1, float[] cc, float[] c1, float[] c2, float[] ch, float[] ch2, float[] wa, int index)
        {
            ...
            int t0, t2 = 0, t3, t4, t5, t6, t7, t8, t9, t10;
            float dc2, ai2, ar2, ds2;
            int nbd;
            float dcp = 0, dsp = 0, ar1h, ar2h;
            int ipp2;
        ...
        {
            int i, k, t2, t3, t4, t6, t7, t8, t9, t10;
        ...
        {
            int idij, ipph = 0, i, j, k, l, ik, iis, t0 = 0, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12;
            float dc2, ai2, ar2, ds2;
            int nbd = 0;
