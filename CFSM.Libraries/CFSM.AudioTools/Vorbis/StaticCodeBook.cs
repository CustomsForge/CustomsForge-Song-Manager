...
namespace CFSM.AudioTools.Vorbis
{
    internal class StaticCodeBook
    {
        ...
        internal StaticCodeBook(int dim, int entries, int[] lengthlist, int maptype, int q_min, int q_delta, int q_quant, int q_sequencep, int[] quantlist //EncodeAuxNearestmatch nearest_tree,
            //Object nearest_tree,
            ...
            ) : this()
        {
            ...
            //  this.thresh_tree = (EncodeAuxNearestMatch)thresh_tree;
        ...
        private static int VQ_FEXP_BIAS = 768; // bias toward values smaller than 1.
