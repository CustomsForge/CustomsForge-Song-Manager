...
namespace CFSM.AudioTools
{
    public class WwiseToOgg
    {
        ...
        public string CodebooksName
        {
            get { return FCodebooksName; }
            set { FCodebooksName = value; }
        }
                        ...
                        catch (codebook_library.Invalid_id E)
                        {
                            if (codebook_id == 0x342)
                            {
                                ...
                                if (codebook_identifier == 0x1590)
                                {
                                    ...
                                    throw new WwiseToOggException("invalid codebook id 0x342"); //, try --full-setup");
                                }
                            }
    ...
    internal class codebook_library
    {
        ...
        public class Invalid_id : WwiseToOggException
        {
            ...
            public Invalid_id(int ID) : base("Invalid ID :" + ID)
            {
                id = ID;
            }
        }

        private int get_codebook_size(int i)
        {
            if (i >= codebook_count - 1 || i < 0) return -1;
            return Convert.ToInt32(codebook_offsets[i + 1] - codebook_offsets[i]);
        }

        private byte[] get_codebook(int i)
        {
    ...
    internal class ogStream : _bitStream
    {
        ...
        public ogStream(Stream astream) : base(astream)
        {
    ...
    internal class Packet6
    {
        ...
        private Int16 _size;
        private Int32 _absolute_granule;
        ...
        internal Int32 granule
        {
            get { return _absolute_granule; }
        }
    ...
    {
        public bitStream(Stream astream) : base(astream)
        {
        }
    ...
    internal class Bit_uint
    {
        ...
        private UInt32 m_BIT_SIZE = 0;

        public int totalI
        {
            get { return Convert.ToInt32(total); }
        }

        public uint bitsize
        {
            get { return m_BIT_SIZE; }
        }
