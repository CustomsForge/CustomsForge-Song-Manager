...
/*
Usage:
 * Add this in the Form_Load method:
...
namespace CustomControls
{
    ...
    public static class SwfDataObjectExtensions
    {
        ...
        public static void SetDragImage(this System.Windows.Forms.IDataObject dataObject, Control control, System.Drawing.Point cursorOffset)
        {
        ...
        public static void SetDragImage(this System.Windows.Forms.IDataObject dataObject, Image image, System.Drawing.Point cursorOffset)
        {
            ...
            try
            {
                ...
                try
                {
                    sourceHelper.InitializeFromBitmap(ref shdi, (IDataObject)dataObject);
                }
        ...
        /// </remarks>
        public static void SetDropDescription(this System.Windows.Forms.IDataObject dataObject, DropImageType type, string format, string insert)
        {
            ...
            ComDataObjectExtensions.SetDropDescription((System.Runtime.InteropServices.ComTypes.IDataObject)dataObject, dd);
        }
        ...
        public static void SetDataEx(this System.Windows.Forms.IDataObject dataObject, string format, object data)
        {
            ...
            System.Runtime.InteropServices.ComTypes.TYMED tymed = GetCompatibleTymed(format, data);
            // If a TYMED was found, we can use the system DataObject
            // to convert our value for us.
            if (tymed != System.Runtime.InteropServices.ComTypes.TYMED.TYMED_NULL)
            {
                formatETC.tymed = tymed;
                ...
                System.Runtime.InteropServices.ComTypes.STGMEDIUM medium;
                ((System.Runtime.InteropServices.ComTypes.IDataObject)conv).GetData(ref formatETC, out medium);
                try
                {
            ...
            else
            {
                ...
                ComDataObjectExtensions.SetManagedData((System.Runtime.InteropServices.ComTypes.IDataObject)dataObject, format, data);
            }
        }
        ...
        private static System.Runtime.InteropServices.ComTypes.TYMED GetCompatibleTymed(string format, object data)
        {
            if (IsFormatEqual(format, DataFormats.Bitmap) && data is System.Drawing.Bitmap)
                return System.Runtime.InteropServices.ComTypes.TYMED.TYMED_GDI;
            if (IsFormatEqual(format, DataFormats.EnhancedMetafile))
                return System.Runtime.InteropServices.ComTypes.TYMED.TYMED_ENHMF;
            if (data is Stream
                ...
                return System.Runtime.InteropServices.ComTypes.TYMED.TYMED_HGLOBAL;
        ...
        public static object GetDataEx(this System.Windows.Forms.IDataObject dataObject, string format)
        {
            ...
            if (data is Stream)
            {
                object data2 = ComDataObjectExtensions.GetManagedData((System.Runtime.InteropServices.ComTypes.IDataObject)dataObject, format);
                if (data2 != null)
                    return data2;
            }
    ...
    public static class DropTargetHelper
    {
        ...
        /// </summary>
        private static IDictionary<Control, System.Windows.Forms.IDataObject> s_dataContext = new Dictionary<Control, System.Windows.Forms.IDataObject>();
        ...
        public static void DragEnter(Control control, System.Windows.Forms.IDataObject data, System.Drawing.Point cursorOffset, DragDropEffects effect)
        {
        ...
        /// </remarks>
        public static void DragEnter(Control control, System.Windows.Forms.IDataObject data, System.Drawing.Point cursorOffset, DragDropEffects effect, string descriptionMessage, string descriptionInsert)
        {
        ...
        /// <param name="cursorOffset">The current cursor's offset relative to the window.</param>
        /// <param name="effect">The accepted drag drop effect.</param>
        public static void Drop(System.Windows.Forms.IDataObject data, System.Drawing.Point cursorOffset, DragDropEffects effect)
        {
            // No need to clear the drop description, but don't keep it stored to avoid memory leaks
            foreach (KeyValuePair<Control, System.Windows.Forms.IDataObject> pair in s_dataContext)
            {
    ...
    public static class SwfDropTargetHelperExtensions
    {
        ...
        public static void DragEnter(this IDropTargetHelper dropHelper, Control control, System.Windows.Forms.IDataObject data, Point cursorOffset, DragDropEffects effect)
        {
            ...
            dropHelper.DragEnter(controlHandle, (IDataObject)data, ref pt, (int)effect);
        }
    ...
    public static class DragSourceHelper
    {
        ...
        private class DragSourceEntry
        {
            ...
            public DragSourceEntry(System.Windows.Forms.IDataObject data)
            {
                this.data = data;
            }
        }
        ...
        /// </summary>
        private static IDictionary<System.Windows.Forms.IDataObject, DropDescriptionFlags> s_dropDescriptions = new Dictionary<System.Windows.Forms.IDataObject, DropDescriptionFlags>();
        ...
        public static System.Windows.Forms.IDataObject CreateDataObject()
        {
        ...
        /// <returns>A new instance of System.Windows.Forms.IDataObject.</returns>
        public static System.Windows.Forms.IDataObject CreateDataObject(Bitmap dragImage, System.Drawing.Point cursorOffset)
        {
            System.Windows.Forms.IDataObject data = CreateDataObject();
        ...
        /// <param name="cursorOffset">The drag image cursor offset.</param>
        /// <returns>A new instance of System.Windows.Forms.IDataObject.</returns>
        public static System.Windows.Forms.IDataObject CreateDataObject(Control control, System.Drawing.Point cursorOffset)
        {
            System.Windows.Forms.IDataObject data = CreateDataObject();
            AllowDropDescription(true);
        ...
        public static void RegisterDefaultDragSource(Control control, System.Windows.Forms.IDataObject data)
        {
            ...
            entry.adviseConnection = ComDataObjectExtensions.Advise(((System.Runtime.InteropServices.ComTypes.IDataObject)data), new AdviseSink(data), DropDescriptionFormat, 0);
        ...
        /// <remarks>Callers must call UnregisterDefaultDragSource when the drag and drop
        /// operation is complete to avoid memory leaks.</remarks>
        public static System.Windows.Forms.IDataObject RegisterDefaultDragSource(Control control, System.Drawing.Point cursorOffset)
        {
            System.Windows.Forms.IDataObject data = CreateDataObject(control, cursorOffset);
        ...
        /// <remarks>Callers must call UnregisterDefaultDragSource when the drag and drop
        /// operation is complete to avoid memory leaks.</remarks>
        public static System.Windows.Forms.IDataObject RegisterDefaultDragSource(Control control, Bitmap dragImage, System.Drawing.Point cursorOffset)
        {
            System.Windows.Forms.IDataObject data = CreateDataObject(dragImage, cursorOffset);
            RegisterDefaultDragSource(control, data);
            return data;
        }
        ...
        public static void UnregisterDefaultDragSource(Control control)
        {
            if (s_dataContext.ContainsKey(control))
            {
                ...
                System.Runtime.InteropServices.ComTypes.IDataObject dataObjectCOM = (System.Runtime.InteropServices.ComTypes.IDataObject)entry.data;
        ...
        {
            System.Windows.Forms.IDataObject dataObject = RegisterDefaultDragSource(control, cursorOffset);
        ...
        {
            System.Windows.Forms.IDataObject dataObject = RegisterDefaultDragSource(control, dragImage, cursorOffset);
            return DoDragDropInternal(control, dataObject, allowedEffects, data);
        }
        ...
        /// <param name="data">The associated data.</param>
        /// <returns>The accepted drop effects from the completed operation.</returns>
        private static DragDropEffects DoDragDropInternal(Control control, System.Windows.Forms.IDataObject dataObject, DragDropEffects allowedEffects, KeyValuePair<string, object>[] data)
        {
        ...
        /// <param name="e">The event arguments.</param>
        public static void DefaultGiveFeedback(System.Windows.Forms.IDataObject data, GiveFeedbackEventArgs e)
        {
        ...
        /// description.</remarks>
        public static void InvalidateDragImage(System.Windows.Forms.IDataObject dataObject)
        {
        ...
        private static bool IsShowingLayered(System.Windows.Forms.IDataObject dataObject)
        {
        ...
        private static bool IsDropDescriptionValid(System.Windows.Forms.IDataObject dataObject)
        {
        ...
        private static bool IsDropDescriptionDefault(System.Windows.Forms.IDataObject dataObject)
        {
        ...
        private static bool InvalidateRequired(System.Windows.Forms.IDataObject dataObject)
        {
            if (s_dropDescriptions.ContainsKey(dataObject))
        ...
        private static void SetDropDescriptionIsDefault(System.Windows.Forms.IDataObject dataObject, bool isDefault)
        {
            if (isDefault)
        ...
        /// <param name="dataObject">The associdated DataObject.</param>
        /// <param name="isDefault">True to set the flag, False to unset it.</param>
        private static void SetInvalidateRequired(System.Windows.Forms.IDataObject dataObject, bool required)
        {
            if (required)
        ...
        private static void SetDropDescriptionFlag(System.Windows.Forms.IDataObject dataObject, DropDescriptionFlags flag)
        {
            if (s_dropDescriptions.ContainsKey(dataObject))
        ...
        private static void UnsetDropDescriptionFlag(System.Windows.Forms.IDataObject dataObject, DropDescriptionFlags flag)
        {
            if (s_dropDescriptions.ContainsKey(dataObject))
            {
        ...
        private static DropImageType GetDropImageType(System.Windows.Forms.IDataObject dataObject)
        {
            object data = ComDataObjectExtensions.GetDropDescription((System.Runtime.InteropServices.ComTypes.IDataObject)dataObject);
            if (data is DropDescription)
        ...
        private class AdviseSink : IAdviseSink
        {
            ...
            private System.Windows.Forms.IDataObject data;

            /// <summary>
            /// Creates an AdviseSink associated to the specified data object.
            /// </summary>
            /// <param name="data">The data object.</param>
            public AdviseSink(System.Windows.Forms.IDataObject data)
            {
                this.data = data;
            }
