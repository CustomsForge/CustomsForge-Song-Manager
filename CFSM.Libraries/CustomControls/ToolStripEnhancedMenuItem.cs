...
namespace CustomControls
{
    ...
    public class ToolStripEnhancedMenuItem : ToolStripMenuItem
    {
        ...
        /// <summary>
        /// To make a RadioButton behave like a CheckBox set the AutoCheck property to false
        /// (permits all radiobuttons to be unchecked)
        /// </summary>
        [DefaultValue(true)]
        [Description("Set the AutoCheck property to false to permit a RadioButton to behave like a CheckBox")]
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            if ((CheckMarkDisplayStyle == CheckMarkDisplayStyle.RadioButton) && (CheckOnClick) && (AutoCheck))
            {
