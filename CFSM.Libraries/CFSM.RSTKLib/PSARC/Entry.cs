...
namespace CFSM.RSTKLib.PSARC
{
    public class Entry : System.IDisposable
    {
        ...
        //My best guess is: RS2014 uses method like PSARCBrowser, 
        //they pick file from PSARC using md5(faster to use first file from collection, 
        //since it's defined be format, haha) and meet 2 of them, so they fail to read filenames from Manifest, 
        //rest is impossible. Changed check to Name instead of Id.
