...
namespace CFMAudioTools
{
    public class Bass
    {
        ...
        private static extern int BASS_StreamCreateFileMemory(
            [MarshalAs(UnmanagedType.Bool)] bool inMemory, IntPtr memory, long offset, long length, BASSFlag flags);
    ...
    public sealed class BASS_INFO
    {
        ...
        {
            return string.Format("Speakers={0}, MinRate={1}, MaxRate={2}, DX={3}, EAX={4}",
                this.speakers, this.minrate, this.maxrate,
               this.dsver, (this.eax ? true : false));
        }
    }
