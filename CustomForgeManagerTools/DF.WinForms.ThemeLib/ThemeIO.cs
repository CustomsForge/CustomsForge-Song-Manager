                    ...
                    if (pn == "extravalues")
                    {
                        ...
                        while (reader.TokenType == JsonToken.StartObject)
                        {
                            ...
                            if (reader.Value.ToString() == "type")
                            {
                                ...
                                var atype =
                                     UtilExtensions.GetLoadableTypes().Where(x => x.Name == xtype).FirstOrDefault();
                                    //UtilExtensions.GetLoadableTypes(this.GetType().Assembly).Where(x => x.Name == xtype).FirstOrDefault();
                                if (atype != null)
                                {
