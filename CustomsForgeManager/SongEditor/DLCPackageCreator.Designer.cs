...
namespace CustomsForgeManager.SongEditor
{
    partial class DLCPackageCreator
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.previewVolumeBox = new NumericUpDownFixed();
            this.packageVersionTB = new CueTextBox();
            this.DlcNameTB = new CueTextBox();
            this.SongDisplayNameTB = new CueTextBox();
            this.ArtistTB = new CueTextBox();
            this.AlbumTB = new CueTextBox();
            this.YearTB = new CueTextBox();
            this.AverageTempoTB = new CueTextBox();
            this.songVolumeBox = new NumericUpDownFixed();
            this.AppIdTB = new CueTextBox();
            this.SongDisplayNameSortTB = new CueTextBox();
            this.ArtistSortTB = new CueTextBox();
            this.albumArtPathTB = new CueTextBox();
            this.audioQualityBox = new NumericUpDownFixed();
            this.audioPathTB = new CueTextBox();
        ...
        private CueTextBox albumArtPathTB;
        ...
        private CueTextBox YearTB;
        private CueTextBox AlbumTB;
        private CueTextBox ArtistTB;
        private CueTextBox SongDisplayNameTB;
        private CueTextBox DlcNameTB;
