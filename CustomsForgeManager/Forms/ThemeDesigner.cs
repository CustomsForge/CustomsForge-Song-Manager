...
namespace CustomsForgeManager.Forms
{
    public partial class ThemeDesigner : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                InitialDirectory = Constants.ThemeDirectory,
                AddExtension = true,
                Filter = String.Format("CFSM Theme Files (*{0})|*{0}",
                Theme.GetThemeExt<CFSMTheme>()),
                FileName = theme.ThemeName + Theme.GetThemeExt<CFSMTheme>()
            })
            {
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            {
                InitialDirectory = Constants.ThemeDirectory,
                Filter = String.Format("CFSM Theme Files (*{0})|*{0}|All Files|*.*", Theme.GetThemeExt<CFSMTheme>())
            })
            {
