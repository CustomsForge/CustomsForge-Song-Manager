    ...
    public partial class Renamer : UserControl
    {
        ...
        public void RenameSongs()
        {
            foreach (SongData data in renSongCollection)
            {
                ...
                try
                {
                    ...
                    Globals.Log(string.Format(CustomsForgeManager.Properties.Resources.Renamer_RenamingFrom, oldFilePath));
        ...
        private void dgvRenamerProperties_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex != -1)
            {
                ...
                txtRenameTemplate.Text = s.Insert(txtRenameTemplate.SelectionStart,
                    String.Format("<{0}>", grid.Rows[e.RowIndex].Cells["Key"].Value));
